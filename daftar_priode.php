    ...
    <div class="x_content">
        ...
        <form class="form-horizontal form-label-left" action="" enctype="multipart/form-data" method="post">
            ...
            <div class="form-group <?= form_error('tahun') ? 'has-error' : null ?>">
                <label class="control-label col-md-2 col-sm-2 col-xs-12">Tahun Priode
                </label>
                <div class="col-md-7 col-sm-6 col-xs-12">
                    <input type="text" class="form-control col-md-7 col-xs-12" name="tahun" value="<?= $tahun; ?>">
                    <?= form_error('tahun') ?>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    ...
                    <a href="<?= base_url('c_priode'); ?>" class="btn btn-primary"><i class="fa fa-undo"></i> Kembali</a>
                </div>
            </div>
