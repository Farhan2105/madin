    ...
    <div class="x_content">
        ...
        <form class="form-vertical form-label-left " action="" enctype="multipart/form-data" method="post">
            ...
            <div class="form-group">
                <div class="col-md-3 col-xs-12">
                    ...
                    <!--  <a class="btn btn-danger" href="<?= base_url('bisyaroh/print_gaji/') . $id_lembaga . '/' . $bulan . '/' . $tahun; ?>" target="_blank"><i class="
                    ...
                    <div class="btn-group">
                        ...
                        <ul role="menu" class="dropdown-menu">
                            <li><a href="<?= base_url('bisyaroh/print_gaji/') . $id_lembaga . '/' . $bulan . '/' . $tahun; ?>" target="_blank"><i class="fa fa-print"></i> Print</a></li>
                            <li><a href="<?= base_url('bisyaroh/export_exel/') . $id_lembaga . '/' . $bulan . '/' . $tahun; ?>" target="_blank"><i class="fa fa-file-text-o"></i> Exel</a></li>
                        </ul>
                    </div>
        ...
        <table id="datatable" class="table table-responsive table-bordered bulk_action">
            <tr>
                ...
                <!-- <th colspan="3" class="text-center" style="vertical-align:middle">Masa Kerja</th> -->
                ...
                <th rowspan="2" class="text-center" style="vertical-align:middle" class="text-right">Bisyaroh</th>
            </tr>
            <tr>
                <!-- <th class="text-center">Bulan</th>
                <th class="text-center">Tahun</th>
                <th class="text-center">Tahun Sekarang</th> -->
                ...
                <th style="vertical-align:middle" class="text-center">GAPOK</th>
                <th style="vertical-align:middle" class="text-center">Struktural</th>
                <th style="vertical-align:middle" class="text-center">Insentif Hadir</th>
                <th style="vertical-align:middle" class="text-center">WALAS</th>
            </tr>
            <?php if ($uri == 1) { ?>
            <?php $no = 1;
            ...
            <tr>
                ...
                <td style="vertical-align:middle" class="text-right"><?= number_format($gapok, 0, ',', '.'); ?></td>
                <td style="vertical-align:middle" class="text-right"><?= number_format($nom_struktural, 0, ',', '.'); ?></td>
                <td style="vertical-align:middle" class="text-right"><?= number_format($gaji, 0, ',', '.'); ?></td>
                <td style="vertical-align:middle" class="text-right"><?= number_format($ada_walas, 0, ',', '.'); ?></td>
                <td style="vertical-align:middle" class="text-right"><?= number_format($jml_bisyaroh, 0, ',', '.'); ?></td>
            </tr>
            <?php
                } ?>
            <?php
